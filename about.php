...
<head>
    ...
    <title>Trust Websites and Development | About</title>
    ...
    <section id="main">
        <div class="container">
            ...
            <aside id="sidebar">
                <div class="dark">
                    <h3>What We Do</h3>
                    <p>We provide the best Website with digital and fast growing frameworks including Django and Laravel and Node.js </p>
                </div>
            </aside>
        </div>
    </section>
